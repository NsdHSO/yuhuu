...
describe('ParticipantsList - i18n', () => {
    ...
    it('should use t("admin.usernameLabel") for username labels', () => {
        const participants = [
            { id: 1, dinnerId: 1, username: 'john', notes: '', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
        ];
    ...
    it('should use t("admin.notesLabel") for notes labels', () => {
        const participants = [
            { id: 1, dinnerId: 1, username: 'john', notes: 'Some note', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
        ];
        render(<ParticipantsList participants={participants} />);
    ...
    it('should pass correct count for multiple participants', () => {
        const participants = [
            { id: 1, dinnerId: 1, username: 'john', notes: '', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
            { id: 2, dinnerId: 1, username: 'jane', notes: '', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
            { id: 3, dinnerId: 1, username: 'bob', notes: '', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
        ];
        render(<ParticipantsList participants={participants} />);
    ...
    it('should not contain hardcoded English strings', () => {
        const participants = [
            { id: 1, dinnerId: 1, username: 'john', notes: 'A note', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
        ];
