...
jest.mock('@react-native-picker/picker', () => {
    ...
    const Picker = function MockPicker(props: any) {
        return React.createElement('View', {testID: props.testID, ...props}, props.children);
    };
    Picker.Item = function MockPickerItem(props: any) {
